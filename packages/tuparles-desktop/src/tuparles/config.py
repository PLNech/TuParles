...
TRIM_PAD_LEAD_MS = _core.TRIM_PAD_LEAD_MS
TRIM_PAD_TAIL_MS = _core.TRIM_PAD_TAIL_MS
TRIM_MIN_RESULT_S = _core.TRIM_MIN_RESULT_S
TRIM_MAX_REMOVED_FRAC = _core.TRIM_MAX_REMOVED_FRAC
TRIM_RMS_TOP_DB = _core.TRIM_RMS_TOP_DB
TRIM_RMS_FRAME_MS = _core.TRIM_RMS_FRAME_MS
COMPRESS_THRESHOLD_DB = _core.COMPRESS_THRESHOLD_DB
COMPRESS_RATIO = _core.COMPRESS_RATIO
COMPRESS_FRAME_MS = _core.COMPRESS_FRAME_MS
COMPRESS_RELEASE_FRAMES = _core.COMPRESS_RELEASE_FRAMES
COMPRESS_MAX_MAKEUP = _core.COMPRESS_MAX_MAKEUP
